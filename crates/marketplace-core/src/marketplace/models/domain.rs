//! Domain-level structs that represent marketplace entities.
//!
//! These types mirror the data model that is documented in `specs/001-build-a-gemini/data-model.md` while preserving the legacy field names that are already used throughout the services layer.
...
/// A unique identifier for an extension, in the format `source-slug/extension-slug`.
