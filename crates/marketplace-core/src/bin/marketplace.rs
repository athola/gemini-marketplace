...
use gemini_marketplace::cli::cache::{
    execute_refresh as execute_cache_refresh, execute_ttl_set as execute_cache_ttl_set,
    CacheRefreshOptions, CacheTtlSetOptions,
};
use gemini_marketplace::cli::list::{execute as execute_list, ListOptions};
use gemini_marketplace::cli::search::{execute as execute_search, SearchOptions};
use gemini_marketplace::cli::show;
use gemini_marketplace::cli::sources;
use gemini_marketplace::cli::status::{execute as execute_status, StatusOptions};
...
async fn main() -> ExitCode {
    ...
    let result = match cli.command {
        ...
        MarketplaceCommand::Show { id, json } => {
            show::execute(show::ShowOptions { id, json }).await
        }
